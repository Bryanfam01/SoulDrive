    ...
    <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-dark nav-items">
        ...
        <img src="pic/logo.png" width="100" class="img-fluid rounded-circle";alt="">
          <a class="mainsel" href="index.html" style="margin-left: 10px;"><h1>NSIT</h1> </a>
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              <li class="nav-item">
                <a class="mainsel" href="desktop.html">Desktop</a>
              </li>
              <li class="nav-item">
                <a class="mainsel" href="laptop.html">Laptop</a>
              </li>
            </ul>
            <form class="form-inline my-2 my-lg-0">
              <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
              <button class="btn btn btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
            </form>
        </div>
    </nav>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner container;col-xl-12">
            <div class="carousel-item active">
              <img class="d-block w-100" src="pic/pic1.jpg" style="position: relative;img-fluid;">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="pic/pic2.jpg" style="position: relative;img-fluid;">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="pic/pic3.jpg" alt="Third slide" style="position: relative;img-fluid;">
            </div>
          </div>
        ...
        <div class="textcontainer;container" style="position: relative;">
          <div class="row textcontainer">
            <div class="col-lg-6 zoom">
              <a href="desktop.html">
              <img src="https://assets.pcmag.com/media/images/563932-the-best-gaming-desktops-of-2017.jpg?thumb=y&width=810&height=456" alt="" class="img-fluid" style="height:456px;"></a>
              <h1 class="centered">Desktop</h1>
            </div>
            <div class="col-lg-6 zoom">
              <a href="laptop.html">
              <img src="pic/laptopmain.webp" alt="" class="img-fluid"  style="height:456px;">
              <h1 class="centered">Laptop</h1></a>
            </div>
          </div>
        </div>
    </body>
